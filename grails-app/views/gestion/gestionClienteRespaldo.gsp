		...
		<div id="productoPrincipalDiv">
						...
						<div class="col-lg-12 col-md-12 col-xs-12">
							<div class="col-lg-12 col-md-12 col-xs-12">
								...
								<p>
									...
									le realizaremos la entrega de una tarjeta adicional categoría <strong><g:if test="${cliente.productoVender == 'DINERS'}">${cliente.productoDiners}</g:if><g:else test="${cliente.productoVender == 'VISA'}">${cliente.productoVisa}</g:else></strong>
									sin ningún costo de mantenimiento, el único valor es el del chip de seguridad de $4.89 con IMPUESTO INCLUIDO; una vez cada 3 años. De la misma forma por aceptar esta tarjeta adicional usted como titular recibe <strong>${cliente.propuestaValor}</strong>
								</p>
			...
			<g:if test="${cliente.tipoProducto == 'APLICA CREDITO VEHICULAR'}">
				...
				<p>
					...
					actuales de su tarjeta a través de la extensión de una tarjeta adicional categoría <strong><g:if test="${cliente.productoVender == 'DINERS'}">${cliente.productoDiners}</g:if><g:else test="${cliente.productoVender == 'VISA'}">${cliente.productoVisa}</g:else></strong> sin ningún costo de
				...
				<p>
					Con la aceptación de esta tarjeta, usted contará con: <strong>${cliente.propuestaValor}</strong>
				</p>
